...
import {onBeforeUnmount, ref, shallowRef, defineEmits, defineProps, onMounted, onBeforeMount} from 'vue'
...
const handleCreated = (editor) => {
  ...
  valueHtml.value = props.messages
}
...
const setMassage = () => {
  ...
  valueHtml.value = JSON.parse(vulInfo).suggestion
}
setMassage()


console.log('propValue的值:', props.messages);

onBeforeMount(() => {
  console.log('在组件挂载之前读取propValue的值:', props.messages);
});
